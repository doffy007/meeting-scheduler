...
import { MapPin, Phone, Mail, Clock, CalendarX } from "lucide-react";
    ...
    async function fetchData() {
      try {
        const [orgRes, setRes] = await Promise.all([
          organizerService.getPublicOrganizerDetail(id),
          organizerSettingsService.publicGetSettings(id)
        ]);
      ...
      <div className="profile-card fade-in-up">
        ...
        <div className="section-block">
          <h3 className="section-title">
            <Clock size={20} className="title-icon" /> Timezone
          </h3>
